         ...
         <div class="row align-items-center">
             ...
             <div class="col-lg-6 col-md-6 col-12">
                 <ul class="breadcrumb-list">
                     ...
                     <li class="item current">Buy NFT </li>
                 </ul>
             </div>
         </div>
     </div>
                         ...
                         <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                             <div class="modal-dialog">
                                 <div class="modal-content">
                                     <form action="{{url('postbuynft')}}/{{$collection->ref}}" method="post">

                                         @csrf

                                         <div class="modal-header">
                                             <h5 class="modal-title" id="exampleModalLabel" style="color:black;">Confirm purchase of this nft</h5>
                                         ...
                                         <div class="modal-body">
                                             ...
                                             <div class="mb-3">
                                                 ...
                                                 <input type="text" class="form-control" value="USD {{$collection->price}}" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
                                                 <div id="emailHelp" class="form-text">All purchases are instant.</div>
                                             </div>
